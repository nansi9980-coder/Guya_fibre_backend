...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Créer un utilisateur (SUPER_ADMIN)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Liste des utilisateurs (EDITOR+)' }),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN'),
    (0, swagger_1.ApiOperation)({ summary: 'Mettre à jour un utilisateur (SUPER_ADMIN)' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('SUPER_ADMIN'),
    (0, swagger_1.ApiOperation)({ summary: 'Supprimer un utilisateur (SUPER_ADMIN)' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
